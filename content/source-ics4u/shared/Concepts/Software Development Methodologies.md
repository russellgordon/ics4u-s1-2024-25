...
> [!NOTE]
> 
> Mr. Gordon generated this concept summary using ChatGPT (here are the [prompts given and responses received](https://chatgpt.com/share/673ca847-83dc-800b-b806-05b31880bdab)).
> 
...
- _Strength_: Clear structure and planning.
- _Weakness_: Inflexible to changes during development.

### Agile

[Agile](http://agilemanifesto.org) is a flexible and team-focused approach.
...
- _Strength_: Adapts to change and includes regular feedback.
- _Weakness_: Needs close communication and teamwork, which can be hard to manage.
...
|---|---|---|
|**Product Owner**|_Business Value_|Ensures the team builds the right thing.|
|**Scrum Master**|_Process and Team Support_|Guides the team and removes roadblocks.|
|**Team Member**|_Execution and Collaboration_|Builds the product and solves problems.|
