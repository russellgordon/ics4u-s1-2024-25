...
> 
> In admissions, we find that sharing an inspiring story is always a much more memorable way to communicate information, but as officers we only capture a small number of the stories out there. With this app I see the potential to capture stories from alumni at on and off campus events as well as current students. From an admissions perspective, here are the search criteria that would be very useful to be able to sort stories by.
>
> - Year / decade
